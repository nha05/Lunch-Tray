...
class CheckoutFragment : Fragment() {
    ...
    fun submitOrder() {
        ...
        val orderSubmit = getString(R.string.order_details,
            sharedViewModel.entree.value?.name.toString(),
            sharedViewModel.side.value?.name.toString(),
            sharedViewModel.accompaniment.value?.name.toString(),
            sharedViewModel.subtotal.value.toString(),
            sharedViewModel.tax.value.toString(),
            sharedViewModel.total.value.toString())

        val intent = Intent(Intent.ACTION_SEND)
            .setType("text/plain")
            .putExtra(Intent.EXTRA_SUBJECT, getString(R.string.new_order))
            .putExtra(Intent.EXTRA_TEXT, orderSubmit)
